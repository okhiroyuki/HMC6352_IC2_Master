...
class HMC6352
{
  ...
  float requestData(void);

  int getOperationalMode(void);
  int getOperationalByte(void);
  void setOperationalMode(const int& mode);
  ...
  private:
    ...
    static const int c_getDataStandby_ 	= 0x41; // A
    // commands (Callibration)
    static const int c_startCalibration_ = 0x43; // C
    static const int c_endCalibration_  = 0x45;  //E
